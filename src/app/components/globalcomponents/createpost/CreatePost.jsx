...
export default function CreatePost({
  ...
  // Function to handle image grid layout
  ...
  // Function to handle image display for more than 4 images
    ...
    <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white rounded-xl shadow-md p-4 w-full max-w-2xl mx-auto">
      ...
      <div className="cursor-pointer flex justify-between items-start mb-3">
        ...
        <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
          <path d="M3.95833 8.83154C3.0875 8.83154 2.375 9.54404 2.375 10.4149C2.375 11.2857 3.0875 11.9982 3.95833 11.9982C4.82917 11.9982 5.54167 11.2857 5.54167 10.4149C5.54167 9.54404 4.82917 8.83154 3.95833 8.83154Z" stroke="#959595" strokeWidth="1.18" />
          <path d="M15.0413 8.83154C14.1705 8.83154 13.458 9.54404 13.458 10.4149C13.458 11.2857 14.1705 11.9982 15.0413 11.9982C15.9122 11.9982 16.6247 11.2857 16.6247 10.4149C16.6247 9.54404 15.9122 8.83154 15.0413 8.83154Z" stroke="#959595" strokeWidth="1.18" />
          <path d="M7.91602 10.4149C7.91602 11.2857 8.62852 11.9982 9.49935 11.9982C10.3702 11.9982 11.0827 11.2857 11.0827 10.4149C11.0827 9.54404 10.3702 8.83154 9.49935 8.83154" stroke="#959595" strokeWidth="1.18" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </div>
          ...
          {displayImages.map((img, index) => (
            <div key={index} className="relative">
              <img
                ...
                className={`w-full h-full object-cover rounded-lg ${displayImages.length === 3 && index === 2 ? 'row-span-2' : ''}`}
              />
      ...
      <div className="flex items-center justify-between text-gray-600 dark:text-gray-300 text-xs sm:text-sm">
        <div className="flex gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1 cursor-pointer" onClick={handleLike}>
            <svg width="19" height="20" viewBox="0 0 19 20" fill={liked ? "#007BFF" : "none"} xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5">
          ...
          <div className="flex items-center gap-1 cursor-pointer" onClick={handleDislike}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill={disliked ? "#FF0000" : "none"} xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5">
        ...
        <div className="flex items-center gap-1 cursor-pointer" onClick={handleHeart}>
          <svg width="20" height="20" viewBox="0 0 20 20" fill={hearted ? "#FF0000" : "none"} xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5">
